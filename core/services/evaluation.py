...
class AssessmentService(EvaluationService):
    ...
    @staticmethod
    def _validate_completeness(ok, sp, is_path_b: bool = False) -> list[str]:
    ...
    @staticmethod
    def get_urgent_assessments(supervisor_id=None) -> list[dict]:
