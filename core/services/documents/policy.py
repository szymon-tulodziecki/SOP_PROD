...
def _docs_standard() -> list:
    return [
        ...
        DocumentEntry("Zał. 2 — Program praktyki", "ZAL_2", t("Z danymi studenta i firmy")),
        _sep("Załącznik nr 3 — Karta Praktyki Zawodowej"),
        DocumentEntry(
            "Zał. 3a — Skierowanie na praktykę",
            "ZAL_3A",
            t("Przepustka do firmy — drukujesz i przynosisz pierwszego dnia"),
        ),
        _sep("W trakcie praktyki"),
        DocumentEntry(
            "Zał. 3b — Karta zakładowa (druk do wypełnienia)",
            "ZAL_3B",
        ...
        DocumentEntry(
            "Zał. 5 — Ankieta oceny praktyki",
            static_key="ankieta",
            description=t("Formularz anonimowej ankiety"),
        ),
        DocumentEntry(
            "Zał. 3c — Ocena uczelniana (UOPZ)",
            "ZAL_3C",
        ...
        DocumentEntry(
            "Zał. 8 — Protokół egzaminu komisji",
            "ZAL_8",
...
def _docs_employment_own_business() -> list:
    return [
        DocumentEntry(
            "Zał. 4b — Wniosek o zaliczenie", "ZAL_4B", t("Praca etatowa / własna działalność")
        ),
        DocumentEntry(
            "Zał. 7a — Sprawozdanie z pracy/działalności",
            "ZAL_7A",
        ...
        DocumentEntry(
            "Zał. 4a — Potwierdzenie efektów uczenia się (komisja)",
            "ZAL_4A",
...
def build_flags(zapis) -> dict:
    ...
    return {
        ...
        "oceniona": zakonczona
        and zapis.final_grades is not None
