...
class CompanyRepository:
    ...
    def paginated_list(
        self, search: str = "", status: str = "wszystkie", page: int = 1, per_page: int = 25
    ):
    ...
    def find_active_by_tax_id(
        self, tax_id: str, exclude_id: Optional[uuid.UUID] = None
    ) -> Optional[Company]:
    ...
    def count_active_internships(
        self, company_id: uuid.UUID, active_statuses: list[EnrollmentStatus]
    ) -> int:
        return (
