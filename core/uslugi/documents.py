...
Zawiera dwie odpowiedzialności:
  ...
  2. Kanoniczny builder kontekstu TeX (build_context)
...
def _dyrektor_lub_zakonczona(ctx):        return ctx['dyrektor_zatwierdził'] or ctx['zakonczona']  # noqa: E704
...
_POWOD_DYREKTOR       = lambda _: 'Dostępny po decyzji dyrektora'               # noqa: E731
...
# ---------------------------------------------------------------------------
# ---------------------------------------------------------------------------
# Context sub-builders (reduce cognitive complexity of build_context)
# ---------------------------------------------------------------------------
