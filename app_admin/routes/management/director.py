...
from core.models import UserRole, EnrollmentStatus
...
def dyrektor_lista():
    ...
    return render_template(
        "zarzadzanie/dyrektor/lista.html", wnioski=applications, csrf_form=csrf_form
    )
...
def dyrektor_decyzja(id):
        ...
        if decision not in ("APPROVED", "REJECTED"):
            ...
            try:
                ...
                if decision == "APPROVED":
                    flash(
                        t(
                            "Wniosek zatwierdzony przez Dyrektora Instytutu. Student może kontynuować praktykę."
                        ),
                        "success",
                    )
                else:
    ...
    return render_template(
        "zarzadzanie/dyrektor/decyzja.html",
        form=form,
        zapis=enrollment,
        dokumenty=documents,
